 ...
 * @param {string} [options.effect='fade'] - The reveal effect. Can be 'fade', 'slide', 'zoom', 'blur', 'flip', 'rotate'.
 ...
 * @param {number} [options.scale=0.9] - For 'zoom' effect, the initial scale of the element.
